import { Union, Record } from "./fable_modules/fable-library.3.7.18/Types.js";
import { class_type, unit_type, MethodInfo, union_type, list_type, option_type, record_type, string_type, int32_type } from "./fable_modules/fable-library.3.7.18/Reflection.js";
import { cons, length as length_1, filter, empty } from "./fable_modules/fable-library.3.7.18/List.js";
import { Cmd_none } from "./fable_modules/Fable.Elmish.3.1.0/cmd.fs.js";
import { equals } from "./fable_modules/fable-library.3.7.18/Util.js";
import { map, orElse } from "./fable_modules/fable-library.3.7.18/Option.js";
import { reverse, length } from "./fable_modules/fable-library.3.7.18/Seq.js";
import { Browser_Types_EventTarget__EventTarget_get_Value, LitHelpers_html } from "./fable_modules/Fable.Lit.1.4.1/Lit.fs.js";
import { fmt } from "./fable_modules/fable-library.3.7.18/String.js";
...
function update(msg, state) {
    switch (msg.tag) {
        ...
        case 2: {
            ...
            current_1 = orElse(map((current) => (new Note(current.Id, title, current.Body)), state.CurrentNote), ifNone);
        ...
        case 3: {
            ...
            current_3 = orElse(map((current_2) => (new Note(current_2.Id, current_2.Title, body)), state.CurrentNote), ifNone_1);
