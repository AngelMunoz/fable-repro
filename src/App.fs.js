...
import { fmt, printf, toConsole } from "./fable_modules/fable-library.3.7.18/String.js";
import { defaultArg } from "./fable_modules/fable-library.3.7.18/Option.js";
...
import { class_type, unit_type, MethodInfo } from "./fable_modules/fable-library.3.7.18/Reflection.js";
...
export function start() {
    const arg_1 = app();
    Lit_render(document.querySelector("#lit-app"), arg_1);
}
